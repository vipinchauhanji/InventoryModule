...
public class QueryConstants {
	...
	public final static String Company_Update_Query="update company set companyname=?,street=?,city=?,district=?,state=?,country=?,mailid=?,contact=?,status=? where id=?";
	
	public final static String Company_Select_ParticularId= "select * from company where id=?";
}
